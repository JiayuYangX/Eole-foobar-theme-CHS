...
let properties = [
	...
	['Fallback Text Biography: Heading|No Heading', '未找到|无简介显示', 'bioFallbackText'],
	['Fallback Text Review: Heading|No Heading', '未找到|无评论显示', 'revFallbackText'],
	...
	['Heading Title Format Album Review', '$if2(%BIO_ALBUMARTIST%,未知专辑艺术家) - $if2(%BIO_ALBUM%,未知专辑)', 'revHeading'],
	...
	['Text Reader 1 Name', '歌词', 'nmTxtReader0'],
	['Text Reader 2 Name', '歌词', 'nmTxtReader1'],
	['Text Reader 3 Name', '歌词', 'nmTxtReader2'],
	['Text Reader 4 Name', '正在播放', 'nmTxtReader3'],
	['Text Reader 5 Name', '歌词', 'nmTxtReader4'],
	['Text Reader 6 Name', '歌词', 'nmTxtReader5'],
	['Text Reader 7 Name', '歌词', 'nmTxtReader6'],
	['Text Reader 8 Name', '音轨信息', 'nmTxtReader7'],
