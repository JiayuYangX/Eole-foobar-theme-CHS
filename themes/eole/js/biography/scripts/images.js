	...
	createImages() {
		...
		for (let i = 0; i < 3; i++) {
			this.stub.default[i] = $.gr(sz, sz, true, g => {
				...
				g.DrawString('无', i == 2 ? font3 : font1, tcol & 0x25ffffff, 0, 0, sz, sz * 275 / 500, cc);
				g.DrawString(['封 面', '照 片', '选 择'][i], i == 2 ? font4 : font2, tcol & 0x20ffffff, 0, sz * 166 / 500, sz, sz * 275 / 500, cc);
